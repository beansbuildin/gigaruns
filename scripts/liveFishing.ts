...
import { SESSION_129_LIMITS, batchVerdict } from "../src/strategy/fishing/oilBatch.js";
...
async function main() {
  ...
  const batchLimits = SESSION_129_LIMITS;
