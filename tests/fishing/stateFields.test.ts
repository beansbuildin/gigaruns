...
describe("SPEC-fishing §4 state-field claims, re-scored against the corpus", () => {
  ...
  it("identifies crits by critZone geometry — and that test discriminates the zone table", () => {
    ...
    expect(corrected.crits).toBe(68);  /* [session 92] was 36 */ // [session 98] was 41 /* [session 102] was 46 */ /* [session 105] was 55 */  /* [session 107] was 61 */  /* [session 110] was 63 */  /* [session 110b] was 67 */
