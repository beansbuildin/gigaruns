...
describe("what holding zero Mid Relaxing Oil costs — EXPECTED, not observed", () => {
  ...
  it("finds the lethal trigger reachable on 15 of 230 casts", () => {
    expect(rows).toHaveLength(564 /* [session 129, day 20707] was 537 */ /* [session 128] was 534 — day 20705 */ /* [session 128] was 509 — day 20705 */ /* [session 124] was 457 */) /* [session 121] was 390 — +20, the whole day-20699 cap */ /* [session 118c] was 388 */ /* [session 118b] was 375 */ /* [session 118] was 367 */ /* [s116b] was 364 */;  /* [session 116] was 339 */;  /* [session 113] was 295 */ // [session 96] was 189; [session 92] was 178  // [session 98] was 199  /* [session 99] was 208 */ /* [session 102] was 210 */ /* [session 105] was 230 */  /* [session 107] was 251 */  /* [session 110] was 273 */  /* [session 110b] was 288 */  /* [session 122] was 410 */  /* [session 123] was 433 */  /* [session 126] was 507 */ /* [session 130, day 20708] was 554 */
  ...
  it("prices it per oil, which is where the corpus and the sim actually agree", () => {
    ...
    expect(gained / oils).toBeCloseTo(0.09090909090909091 /* [session 124] was 0.09523809523809523 */, /* [session 116] was 0.1111111111111111 */ 3); // [session 80] 2/12 -> 2/13. /* [session 102] was 0.1538 */ /* [session 105] was 0.13333333333333333 */  /* [session 107] was 0.125 */  /* [session 110b] was 0.11764705882352941 */
    ...
    expect(reachable.length).toBe(22 /* [session 124] was 21 */) /* [session 116] was 18 */; // the numerator itself, pinned since session 90 /* [session 102] was 13 */ /* [session 105] was 15 */  /* [session 107] was 16 */  /* [session 110b] was 17 */
