...
describe("what holding zero Mid Relaxing Oil costs — EXPECTED, not observed", () => {
  ...
  it("finds the lethal trigger reachable on 15 of 230 casts", () => {
    expect(rows).toHaveLength(584 /* [session 131, day 20709] was 564 */ /* [session 129, day 20707] was 537 */ /* [session 128] was 534 — day 20705 */ /* [session 128] was 509 — day 20705 */ /* [session 124] was 457 */) /* [session 121] was 390 — +20, the whole day-20699 cap */ /* [session 118c] was 388 */ /* [session 118b] was 375 */ /* [session 118] was 367 */ /* [s116b] was 364 */;  /* [session 116] was 339 */;  /* [session 113] was 295 */ // [session 96] was 189; [session 92] was 178  // [session 98] was 199  /* [session 99] was 208 */ /* [session 102] was 210 */ /* [session 105] was 230 */  /* [session 107] was 251 */  /* [session 110] was 273 */  /* [session 110b] was 288 */  /* [session 122] was 410 */  /* [session 123] was 433 */  /* [session 126] was 507 */ /* [session 130, day 20708] was 554 */
...
describe("the 16-cast gap, answered by MEMBERSHIP", () => {
  ...
  it("a caught cast CAN be in the gap — one does, and only via an oil-ended cast", () => {
    ...
    expect(caught.filter((c) => gap.some((g) => g.docId === c.docId)).map((c) => c.docId).sort()).toEqual(["13022748", "13024562", "13055929", "13071770", "13073296", "13106720", "13106726", "13106738", "13106752", "13131292", "13156427", "13187635", "13187637", "13208300", "13222306", "13223400", "13242358", "13267022", "13270110", "13355562" /* [session 128] +1 from day 20705 — ADDITIVE, nothing removed */]);  /* [session 118c] +`13223400`, the final batch's oil cast, CAUGHT */  /* [session 118] was 14 docIds -> 15: +`13222306`, the day-20698 oil cast, which was CAUGHT and so lands in this caught-and-in-gap set too */  /* [session 116] was 13 docIds -> 14: +`13208300` */  /* [session 114] was 11 docIds -> 13 */ /* [session 105] +1: `13131292`, from the 21-cast day */
  });
