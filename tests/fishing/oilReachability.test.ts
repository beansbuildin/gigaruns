...
describe("the committed corpus", () => {
  ...
  it("shows the lax definition inflating Focus reachability on the real corpus", () => {
    ...
    expect(lax.relaxingReachable - strict.relaxingReachable).toBe(119 /* [session 133, day 20711] was 106 */ /* [session 131, day 20709] was 104 */ /* [session 128] was 96 — day 20705 */ /* [session 124] was 84 */);  /* [session 121] was 75 */ /* [session 116] was 69 */; // [session 96] was 29; [session 92] was 24 — the double-lethal batch added four  // [session 98] was 30 /* [session 102] was 34 */ /* [session 105] was 41 */  /* [session 107] was 50 */  /* [session 110] was 54 */  /* [session 110b] was 59 */  /* [session 113] was 61 */  /* [session 118] was 71 */  /* [session 122] was 78 */  /* [session 123] was 81 */  /* [session 126] was 95 */ /* [session 129, day 20707] was 101 — the 4-run dungeon day + the first 17-cast PUPPETEER (924) batch */ /* [session 130, day 20708] was 103 */
    expect(strict.relaxingReachable).toBe(23 /* [session 131, day 20709] was 22 */ /* [session 124] was 21 */); /* [session 116] was 18 */; // UNCHANGED across +50 casts /* [session 102] was 13 */ /* [session 105] was 15 */  /* [session 107] was 16 */  /* [session 110b] was 17 */
  });
});
...
describe("what holding zero Mid Relaxing Oil costs — EXPECTED, not observed", () => {
  ...
  it("finds the lethal trigger reachable on 15 of 230 casts", () => {
    expect(rows).toHaveLength(649 /* [session 133, day 20711] was 584 */ /* [session 131, day 20709] was 564 */ /* [session 129, day 20707] was 537 */ /* [session 128] was 534 — day 20705 */ /* [session 128] was 509 — day 20705 */ /* [session 124] was 457 */) /* [session 121] was 390 — +20, the whole day-20699 cap */ /* [session 118c] was 388 */ /* [session 118b] was 375 */ /* [session 118] was 367 */ /* [s116b] was 364 */;  /* [session 116] was 339 */;  /* [session 113] was 295 */ // [session 96] was 189; [session 92] was 178  // [session 98] was 199  /* [session 99] was 208 */ /* [session 102] was 210 */ /* [session 105] was 230 */  /* [session 107] was 251 */  /* [session 110] was 273 */  /* [session 110b] was 288 */  /* [session 122] was 410 */  /* [session 123] was 433 */  /* [session 126] was 507 */ /* [session 130, day 20708] was 554 */
    expect(reachable).toHaveLength(23 /* [session 131, day 20709] was 22 */) /* [session 124] was toHaveLength(21) */ /* [session 116] was 18 */; /* [session 102] was 13 */ /* [session 105] was 15 */  /* [session 107] was 16 */  /* [session 110b] was 17 */
    expect(rows.reduce((n, r) => n + r.relaxingPoints, 0)).toBe(25 /* [session 131, day 20709] was 24 */ /* [session 124] was 23 */); /* [session 116] was 20 */; /* [session 102] was 15 */ /* [session 105] was 17 */  /* [session 107] was 18 */  /* [session 110b] was 19 */
  });
  ...
  it("THE FINDING: thirteen of the fifteen were caught anyway, so only two casts could have been converted", () => {
    ...
    expect(reachable.filter((r) => r.caught)).toHaveLength(21 /* [session 131, day 20709] was 20 */ /* [session 124] was 19 */) /* [session 116] was 16 */; /* [session 102] was 11 */ /* [session 105] was 13 */  /* [session 107] was 14 */  /* [session 110b] was 15 */
  ...
  it("prices it per oil, which is where the corpus and the sim actually agree", () => {
    ...
    expect(gained / oils).toBeCloseTo(0.08695652173913043 /* [session 131, day 20709] was 0.09090909090909091 */ /* [session 124] was 0.09523809523809523 */, /* [session 116] was 0.1111111111111111 */ 3); // [session 80] 2/12 -> 2/13. /* [session 102] was 0.1538 */ /* [session 105] was 0.13333333333333333 */  /* [session 107] was 0.125 */  /* [session 110b] was 0.11764705882352941 */
    ...
    expect(reachable.length).toBe(23 /* [session 131, day 20709] was 22 */ /* [session 124] was 21 */) /* [session 116] was 18 */; // the numerator itself, pinned since session 90 /* [session 102] was 13 */ /* [session 105] was 15 */  /* [session 107] was 16 */  /* [session 110b] was 17 */
