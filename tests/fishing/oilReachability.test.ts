...
describe("the 16-cast gap, answered by MEMBERSHIP", () => {
  ...
  it("a caught cast CAN be in the gap — one does, and only via an oil-ended cast", () => {
    ...
    expect(caught.filter((c) => gap.some((g) => g.docId === c.docId)).map((c) => c.docId).sort()).toEqual(["13022748", "13024562", "13055929", "13071770", "13073296", "13106720", "13106726", "13106738", "13106752", "13131292", "13156427", "13187635", "13187637", "13208300", "13222306", "13223400", "13242358", "13267022", "13270110", "13355562" /* [session 128] +1 from day 20705 — ADDITIVE, nothing removed */, "13434233", "13434264", "13523114", "13523119" /* [session 136, day 20716] +2 from the 26-cast day; additive, 0 removed */ /* [session 133, day 20711] +2 */]);  /* [session 118c] +`13223400`, the final batch's oil cast, CAUGHT */  /* [session 118] was 14 docIds -> 15: +`13222306`, the day-20698 oil cast, which was CAUGHT and so lands in this caught-and-in-gap set too */  /* [session 116] was 13 docIds -> 14: +`13208300` */  /* [session 114] was 11 docIds -> 13 */ /* [session 105] +1: `13131292`, from the 21-cast day */
  });
