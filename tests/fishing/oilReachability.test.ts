...
describe("the committed corpus", () => {
  ...
  it("shows the lax definition inflating Focus reachability on the real corpus", () => {
    ...
    expect(lax.relaxingReachable - strict.relaxingReachable).toBe(121 /* [session 133, day 20711] was 106 */ /* [session 131, day 20709] was 104 */ /* [session 128] was 96 — day 20705 */ /* [session 124] was 84 */);  /* [session 121] was 75 */ /* [session 116] was 69 */; // [session 96] was 29; [session 92] was 24 — the double-lethal batch added four  // [session 98] was 30 /* [session 102] was 34 */ /* [session 105] was 41 */  /* [session 107] was 50 */  /* [session 110] was 54 */  /* [session 110b] was 59 */  /* [session 113] was 61 */  /* [session 118] was 71 */  /* [session 122] was 78 */  /* [session 123] was 81 */  /* [session 126] was 95 */ /* [session 129, day 20707] was 101 — the 4-run dungeon day + the first 17-cast PUPPETEER (924) batch */ /* [session 130, day 20708] was 103 */
    expect(strict.relaxingReachable).toBe(24 /* [session 131, day 20709] was 22 */ /* [session 124] was 21 */); /* [session 116] was 18 */; // UNCHANGED across +50 casts /* [session 102] was 13 */ /* [session 105] was 15 */  /* [session 107] was 16 */  /* [session 110b] was 17 */
  });
});
...
describe("what holding zero Mid Relaxing Oil costs — EXPECTED, not observed", () => {
  ...
  it("finds the lethal trigger reachable on 15 of 230 casts", () => {
    expect(rows).toHaveLength(674 /* [session 133, day 20711] was 584 */ /* [session 131, day 20709] was 564 */ /* [session 129, day 20707] was 537 */ /* [session 128] was 534 — day 20705 */ /* [session 128] was 509 — day 20705 */ /* [session 124] was 457 */) /* [session 121] was 390 — +20, the whole day-20699 cap */ /* [session 118c] was 388 */ /* [session 118b] was 375 */ /* [session 118] was 367 */ /* [s116b] was 364 */;  /* [session 116] was 339 */;  /* [session 113] was 295 */ // [session 96] was 189; [session 92] was 178  // [session 98] was 199  /* [session 99] was 208 */ /* [session 102] was 210 */ /* [session 105] was 230 */  /* [session 107] was 251 */  /* [session 110] was 273 */  /* [session 110b] was 288 */  /* [session 122] was 410 */  /* [session 123] was 433 */  /* [session 126] was 507 */ /* [session 130, day 20708] was 554 */
    expect(reachable).toHaveLength(24 /* [session 131, day 20709] was 22 */) /* [session 124] was toHaveLength(21) */ /* [session 116] was 18 */; /* [session 102] was 13 */ /* [session 105] was 15 */  /* [session 107] was 16 */  /* [session 110b] was 17 */
    expect(rows.reduce((n, r) => n + r.relaxingPoints, 0)).toBe(26 /* [session 131, day 20709] was 24 */ /* [session 124] was 23 */); /* [session 116] was 20 */; /* [session 102] was 15 */ /* [session 105] was 17 */  /* [session 107] was 18 */  /* [session 110b] was 19 */
  });
  ...
  it("THE FINDING: thirteen of the fifteen were caught anyway, so only two casts could have been converted", () => {
    ...
    expect(reachable.filter((r) => r.caught)).toHaveLength(22 /* [session 131, day 20709] was 20 */ /* [session 124] was 19 */) /* [session 116] was 16 */; /* [session 102] was 11 */ /* [session 105] was 13 */  /* [session 107] was 14 */  /* [session 110b] was 15 */
  ...
  it("prices it per oil, which is where the corpus and the sim actually agree", () => {
    ...
    expect(gained / oils).toBeCloseTo(0.0833 /* [session 131, day 20709] was 0.09090909090909091 */ /* [session 124] was 0.09523809523809523 */, /* [session 116] was 0.1111111111111111 */ 3); // [session 135] was 0.08695652173913043; [session 80] 2/12 -> 2/13. /* [session 102] was 0.1538 */ /* [session 105] was 0.13333333333333333 */  /* [session 107] was 0.125 */  /* [session 110b] was 0.11764705882352941 */
    ...
    expect(reachable.length).toBe(24 /* [session 131, day 20709] was 22 */ /* [session 124] was 21 */) /* [session 116] was 18 */; // [session 135] was 23; the numerator itself, pinned since session 90 /* [session 102] was 13 */ /* [session 105] was 15 */  /* [session 107] was 16 */  /* [session 110b] was 17 */
...
describe("the 16-cast gap, answered by MEMBERSHIP", () => {
  ...
  it("a caught cast CAN be in the gap — one does, and only via an oil-ended cast", () => {
    ...
    expect(caught.filter((c) => gap.some((g) => g.docId === c.docId)).map((c) => c.docId).sort()).toEqual(["13022748", "13024562", "13055929", "13071770", "13073296", "13106720", "13106726", "13106738", "13106752", "13131292", "13156427", "13187635", "13187637", "13208300", "13222306", "13223400", "13242358", "13267022", "13270110", "13355562" /* [session 128] +1 from day 20705 — ADDITIVE, nothing removed */, "13434233", "13434264" /* [session 133, day 20711] +2 */]);  /* [session 118c] +`13223400`, the final batch's oil cast, CAUGHT */  /* [session 118] was 14 docIds -> 15: +`13222306`, the day-20698 oil cast, which was CAUGHT and so lands in this caught-and-in-gap set too */  /* [session 116] was 13 docIds -> 14: +`13208300` */  /* [session 114] was 11 docIds -> 13 */ /* [session 105] +1: `13131292`, from the 21-cast day */
  });
