...
describe("the committed corpus", () => {
  ...
  it("shows the lax definition inflating Focus reachability on the real corpus", () => {
    ...
    expect(lax.focusReachable - strict.focusReachable).toBe(54 /* [session 124] was 49 */);  /* [session 121] was 41 */ /* [session 116] was 36 */; // [session 96] was 20; [session 92] was 18 /* [session 102] was 21 */ /* [session 105] was 25 */  /* [session 107] was 27 */  /* [session 110] was 30 */  /* [session 118] was 38 */  /* [session 122] was 43 */  /* [session 123] was 46 */  /* [session 126] was 53 */
...
describe("what holding zero Mid Relaxing Oil costs — EXPECTED, not observed", () => {
  ...
  it("finds the lethal trigger reachable on 15 of 230 casts", () => {
    expect(rows).toHaveLength(509 /* [session 124] was 457 */) /* [session 121] was 390 — +20, the whole day-20699 cap */ /* [session 118c] was 388 */ /* [session 118b] was 375 */ /* [session 118] was 367 */ /* [s116b] was 364 */;  /* [session 116] was 339 */;  /* [session 113] was 295 */ // [session 96] was 189; [session 92] was 178  // [session 98] was 199  /* [session 99] was 208 */ /* [session 102] was 210 */ /* [session 105] was 230 */  /* [session 107] was 251 */  /* [session 110] was 273 */  /* [session 110b] was 288 */  /* [session 122] was 410 */  /* [session 123] was 433 */  /* [session 126] was 507 */
...
describe("the 16-cast gap, answered by MEMBERSHIP", () => {
  ...
  it("is these exact 16 casts, and the two newest are BOTH from live oil batches", () => {
    ...
    expect(gap.map((c) => c.docId).sort()).toEqual([
      ...
      "13338568", // [session 126] +1 from the day-20704 oil batch — the day-20704 batch's SECOND cast, which ESCAPED after 8 turns. Verified ADDITIVE — nothing dropped out of the gap set.
