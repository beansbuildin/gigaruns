...
describe("the aim-error distribution — is the miss structured or diffuse?", () => {
  it("is concentrated near the footprint rather than flat", () => {
    ...
    expect(h.get(4)).toBe(22 /* [session 128] was 21 — day 20705 */) /* [s116b] was 16 */;  /* [session 121] was 17 */ // was 9 /* [session 102] was 11 */ /* [session 105] was 12 */  /* [session 110b] was 14 */  /* [session 122] was 18 */  /* [session 123] was 19 */
