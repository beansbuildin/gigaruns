...
describe("the aim-error distribution — is the miss structured or diffuse?", () => {
  ...
  it("counts the plays with NO on-grid footprint — a guaranteed miss, not a bad prediction", () => {
    ...
    expect(none.length).toBe(40 /* [session 124] was 37 */);  /* [session 121] was 33 */ /* [session 116] was 31 */; // [session 92] was 25  /* [session 110] was 27 */  /* [session 110b] was 28 */  /* [session 113] was 29 */  /* [session 118] was 32 */  /* [session 122] was 34 */
    expect(result.noFootprint).toBe(40 /* [session 124] was 37 */);  /* [session 121] was 33 */ /* [session 116] was 31 */; // [session 92] was 25  /* [session 110] was 27 */  /* [session 110b] was 28 */  /* [session 113] was 29 */  /* [session 118] was 32 */  /* [session 122] was 34 */
