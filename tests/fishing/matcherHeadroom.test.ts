...
describe("matcher headroom — the scoreboard the matcher is scored against", () => {
  it("scores the stated predicate, and the predicate is the one zoneAudit uses", () => {
    ...
    expect(result.plays).toBe(1436); /* [session 116] was 1320 */; // [session 96] was 777; [session 92] was 751  // [session 98] was 820  /* [session 99] was 860 */ /* [session 102] was 869 */ /* [session 105] was 939 */  /* [session 107] was 989 */  /* [session 110] was 1058 */  /* [session 110b] was 1125 */  /* [session 113] was 1147 */
    expect(result.casts).toBe(364); /* [session 116] was 339 */; // [session 96] was 189; [session 92] was 178  // [session 98] was 199  /* [session 99] was 208 */ /* [session 102] was 210 */ /* [session 105] was 230 */  /* [session 107] was 251 */  /* [session 110] was 273 */  /* [session 110b] was 288 */  /* [session 113] was 295 */
  });
...
describe("the focus budget, reconstructed rather than read off the stale meter", () => {
  it("spent + remaining recovers the pre-play meter on every non-oil play", () => {
    ...
    expect(holds).toBe(1412); /* [session 116] was 1296 */; // [session 96] was 753; [session 92] was 727  // [session 98] was 796  /* [session 99] was 836 */ /* [session 102] was 845 */ /* [session 105] was 915 */  /* [session 107] was 965 */  /* [session 110] was 1034 */  /* [session 110b] was 1101 */  /* [session 113] was 1123 */
...
describe("the aim-error distribution — is the miss structured or diffuse?", () => {
  it("is concentrated near the footprint rather than flat", () => {
    ...
    expect(total).toBe(801); /* [session 116] was 745 */; // [session 96] was 459; [session 92] was 445  // [session 98] was 487  /* [session 99] was 509 */ /* [session 102] was 514 */ /* [session 105] was 550 */  /* [session 107] was 573 */  /* [session 110] was 612 */  /* [session 110b] was 644 */  /* [session 113] was 653 */
    expect(h.get(1)).toBe(420); /* [session 116] was 386 */; // [session 96] was 226; [session 92] was 220  // [session 98] was 243  /* [session 99] was 251 */ /* [session 102] was 254 */ /* [session 105] was 274 */  /* [session 107] was 287 */  /* [session 110] was 314 */  /* [session 110b] was 333 */  /* [session 113] was 339 */
    expect(h.get(2)).toBe(290); /* [session 116] was 270 */; // [session 96] was 171; [session 92] was 164  // [session 98] was 180  /* [session 99] was 194 */ /* [session 102] was 196 */ /* [session 105] was 208 */  /* [session 107] was 216 */  /* [session 110] was 224 */  /* [session 110b] was 233 */  /* [session 113] was 235 */
    ...
    expect(h.get(4)).toBe(16); // was 9 /* [session 102] was 11 */ /* [session 105] was 12 */  /* [session 110b] was 14 */
  ...
  it("counts the plays with NO on-grid footprint — a guaranteed miss, not a bad prediction", () => {
    ...
    expect([...result.aimErrorHist.values()].reduce((a, b) => a + b, 0)).toBe(1404); /* [session 116] was 1289 */; // [session 96] was 750; [session 92] was 726  // [session 98] was 793  /* [session 99] was 833 */ /* [session 102] was 842 */ /* [session 105] was 912 */  /* [session 107] was 962 */  /* [session 110] was 1031 */  /* [session 110b] was 1097 */  /* [session 113] was 1118 */
    expect([...result.aimErrorHist.values()].reduce((a, b) => a + b, 0)).toBe(result.plays - result.noFootprint);
    expect(result.perPlay.filter((p) => !p.actualHit).length).toBe(833); /* [session 116] was 776 */; // [session 96] was 486; [session 92] was 470  // [session 98] was 514  /* [session 99] was 536 */ /* [session 102] was 541 */ /* [session 105] was 577 */  /* [session 107] was 600 */  /* [session 110] was 639 */  /* [session 110b] was 672 */  /* [session 113] was 682 */
  });
});
