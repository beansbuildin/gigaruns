...
describe("matcher headroom — the scoreboard the matcher is scored against", () => {
  it("scores the stated predicate, and the predicate is the one zoneAudit uses", () => {
    ...
    expect(result.plays).toBe(1522) /* [s116b] was 1436 */; /* [session 116] was 1320 */; // [session 96] was 777; [session 92] was 751  // [session 98] was 820  /* [session 99] was 860 */ /* [session 102] was 869 */ /* [session 105] was 939 */  /* [session 107] was 989 */  /* [session 110] was 1058 */  /* [session 110b] was 1125 */  /* [session 113] was 1147 */  /* [session 118] was 1444 */
    expect(result.casts).toBe(390) /* [s116b] was 364 */; /* [session 116] was 339 */; // [session 96] was 189; [session 92] was 178  // [session 98] was 199  /* [session 99] was 208 */ /* [session 102] was 210 */ /* [session 105] was 230 */  /* [session 107] was 251 */  /* [session 110] was 273 */  /* [session 110b] was 288 */  /* [session 113] was 295 */  /* [session 118] was 367 */
  });
  ...
  it("reproduces the four rates — floor, actual, and both ceilings", () => {
    ...
    expect(result.cardSelectionValue).toBeCloseTo(0.03942181340341655, 3); // [session 96] was 0.045; [session 92] was 0.045; 0.047 before that  // [session 98] was 0.044  /* [session 99] was 0.041860465116279055 */ /* [session 105] was 0.04257767548906788 */  /* [session 107] was 0.041456016177957467 */  /* [session 110] was 0.04064272211720221 */  /* [session 110b] was 0.040000000000000036 */  /* [session 118] was 0.04097646033129909 */
  });
...
describe("the focus budget, reconstructed rather than read off the stale meter", () => {
  it("spent + remaining recovers the pre-play meter on every non-oil play", () => {
    ...
    expect(holds).toBe(1498) /* [s116b] was 1412 */; /* [session 116] was 1296 */; // [session 96] was 753; [session 92] was 727  // [session 98] was 796  /* [session 99] was 836 */ /* [session 102] was 845 */ /* [session 105] was 915 */  /* [session 107] was 965 */  /* [session 110] was 1034 */  /* [session 110b] was 1101 */  /* [session 113] was 1123 */  /* [session 118] was 1420 */
...
describe("the aim-error distribution — is the miss structured or diffuse?", () => {
  it("is concentrated near the footprint rather than flat", () => {
    ...
    expect(total).toBe(843) /* [s116b] was 801 */; /* [session 116] was 745 */; // [session 96] was 459; [session 92] was 445  // [session 98] was 487  /* [session 99] was 509 */ /* [session 102] was 514 */ /* [session 105] was 550 */  /* [session 107] was 573 */  /* [session 110] was 612 */  /* [session 110b] was 644 */  /* [session 113] was 653 */  /* [session 118] was 807 */
    ...
    expect(h.get(2)).toBe(308) /* [s116b] was 290 */; /* [session 116] was 270 */; // [session 96] was 171; [session 92] was 164  // [session 98] was 180  /* [session 99] was 194 */ /* [session 102] was 196 */ /* [session 105] was 208 */  /* [session 107] was 216 */  /* [session 110] was 224 */  /* [session 110b] was 233 */  /* [session 113] was 235 */  /* [session 118] was 291 */
