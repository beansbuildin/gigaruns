...
describe("matcher headroom — the scoreboard the matcher is scored against", () => {
  it("scores the stated predicate, and the predicate is the one zoneAudit uses", () => {
    ...
    expect(result.plays).toBe(1320); // [session 96] was 777; [session 92] was 751  // [session 98] was 820  /* [session 99] was 860 */ /* [session 102] was 869 */ /* [session 105] was 939 */  /* [session 107] was 989 */  /* [session 110] was 1058 */  /* [session 110b] was 1125 */  /* [session 113] was 1147 */
    expect(result.casts).toBe(339); // [session 96] was 189; [session 92] was 178  // [session 98] was 199  /* [session 99] was 208 */ /* [session 102] was 210 */ /* [session 105] was 230 */  /* [session 107] was 251 */  /* [session 110] was 273 */  /* [session 110b] was 288 */  /* [session 113] was 295 */
  });
  ...
  it("reproduces the four rates — floor, actual, and both ceilings", () => {
    ...
    expect(result.stayPut).toBeCloseTo(0.2727272727272727, 3); // [session 93] was 0.244; [session 92] was 0.245  // [session 98] was 0.243  /* [session 99] was 0.24069767441860465 */ /* [session 102] was 0.24165707710011508 */ /* [session 105] was 0.24813631522896698 */  /* [session 107] was 0.2527805864509606 */  /* [session 110] was 0.2580340264650284 */  /* [session 110b] was 0.264 */  /* [session 113] was 0.2632955536181343 */
    expect(result.actual).toBeCloseTo(0.4121212121212121, 3); // [session 96] was 0.375; was 0.374  // [session 98] was 0.373  /* [session 99] was 0.3767441860465116 */ /* [session 102] was 0.37744533947065595 */ /* [session 105] was 0.3855165069222577 */  /* [session 107] was 0.39332659251769464 */  /* [session 110] was 0.3960302457466919 */  /* [session 110b] was 0.4026666666666667 */  /* [session 113] was 0.40540540540540543 */
    expect(result.oracleSameCard).toBeCloseTo(0.6886363636363636, 3); // [session 96] was 0.665; was 0.662  // [session 98] was 0.67  /* [session 99] was 0.6686046511627907 */ /* [session 102] was 0.6708860759493671 */ /* [session 105] was 0.6773162939297125 */  /* [session 107] was 0.6855409504550051 */  /* [session 110] was 0.6880907372400756 */  /* [session 110b] was 0.6906666666666667 */
    expect(result.oracleBestCard).toBeCloseTo(0.7295454545454545, 3); // [session 96] was 0.710  // [session 98] was 0.713  /* [session 99] was 0.7104651162790697 */ /* [session 102] was 0.713463751438435 */ /* [session 105] was 0.7199148029818956 */  /* [session 107] was 0.7269969666329625 */  /* [session 110] was 0.7287334593572778 */

    // The derived readings the report prints, pinned so a change to the
    // arithmetic is caught rather than the inputs alone.
    expect(result.capturedFraction).toBeCloseTo(0.4236662862720617, 3); // [session 96] was 0.378; [session 92] was 0.373  // [session 98] was 0.37 /* [session 102] was 0.3767306766193111 */ /* [session 105] was 0.38672110799867043 */  /* [session 107] was 0.39454922898190053 */  /* [session 110] was 0.400024712133069 */  /* [session 110b] was 0.4054888855835782 */  /* [session 113] was 0.41173012750495225 */
    expect(result.headroomRemaining).toBeCloseTo(0.2765151515151515, 3); // [session 96] was 0.291; [session 91] was 0.288 // was 0.301  // [session 98] was 0.296  /* [session 99] was 0.29186046511627906 */ /* [session 102] was 0.29344073647871116 */  /* [session 110] was 0.2917997870074548 */  /* [session 110b] was 0.288 */  /* [session 113] was 0.28421970357454224 */
...
describe("the focus budget, reconstructed rather than read off the stale meter", () => {
  it("spent + remaining recovers the pre-play meter on every non-oil play", () => {
    ...
    expect(holds).toBe(1296); // [session 96] was 753; [session 92] was 727  // [session 98] was 796  /* [session 99] was 836 */ /* [session 102] was 845 */ /* [session 105] was 915 */  /* [session 107] was 965 */  /* [session 110] was 1034 */  /* [session 110b] was 1101 */  /* [session 113] was 1123 */
...
describe("the aim-error distribution — is the miss structured or diffuse?", () => {
  it("is concentrated near the footprint rather than flat", () => {
    ...
    expect(total).toBe(745); // [session 96] was 459; [session 92] was 445  // [session 98] was 487  /* [session 99] was 509 */ /* [session 102] was 514 */ /* [session 105] was 550 */  /* [session 107] was 573 */  /* [session 110] was 612 */  /* [session 110b] was 644 */  /* [session 113] was 653 */
    expect(h.get(1)).toBe(386); // [session 96] was 226; [session 92] was 220  // [session 98] was 243  /* [session 99] was 251 */ /* [session 102] was 254 */ /* [session 105] was 274 */  /* [session 107] was 287 */  /* [session 110] was 314 */  /* [session 110b] was 333 */  /* [session 113] was 339 */
    expect(h.get(2)).toBe(270); // [session 96] was 171; [session 92] was 164  // [session 98] was 180  /* [session 99] was 194 */ /* [session 102] was 196 */ /* [session 105] was 208 */  /* [session 107] was 216 */  /* [session 110] was 224 */  /* [session 110b] was 233 */  /* [session 113] was 235 */
    expect(h.get(3)).toBe(72); // [session 96] was 50; [session 91] was 46 /* [session 102] was 52 */  /* [session 107] was 55 */  /* [session 110] was 59 */  /* [session 113] was 63 */
  ...
  it("counts the plays with NO on-grid footprint — a guaranteed miss, not a bad prediction", () => {
    ...
    expect(none.length).toBe(31); // [session 92] was 25  /* [session 110] was 27 */  /* [session 110b] was 28 */  /* [session 113] was 29 */
    expect(result.noFootprint).toBe(31); // [session 92] was 25  /* [session 110] was 27 */  /* [session 110b] was 28 */  /* [session 113] was 29 */
    ...
    expect([...result.aimErrorHist.values()].reduce((a, b) => a + b, 0)).toBe(1289); // [session 96] was 750; [session 92] was 726  // [session 98] was 793  /* [session 99] was 833 */ /* [session 102] was 842 */ /* [session 105] was 912 */  /* [session 107] was 962 */  /* [session 110] was 1031 */  /* [session 110b] was 1097 */  /* [session 113] was 1118 */
    expect([...result.aimErrorHist.values()].reduce((a, b) => a + b, 0)).toBe(result.plays - result.noFootprint);
    expect(result.perPlay.filter((p) => !p.actualHit).length).toBe(776); // [session 96] was 486; [session 92] was 470  // [session 98] was 514  /* [session 99] was 536 */ /* [session 102] was 541 */ /* [session 105] was 577 */  /* [session 107] was 600 */  /* [session 110] was 639 */  /* [session 110b] was 672 */  /* [session 113] was 682 */
  });
});
