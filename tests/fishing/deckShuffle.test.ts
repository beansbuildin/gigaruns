...
describe("§1a — the live corpus falsifies the sequential draw pile", () => {
  ...
  it("live opening hands match fullDeck[0..handSize-1] at CHANCE, not at the sequential model's 100%", () => {
    ...
    expect(LIVE.length).toBe(570 /* [session 128] was 540 — day 20705 */ /* [session 128] was 515 — +25, day 20705 */); /* [session 126] the denominator the 6 is read against — pinned so the pair moves together */ /* [session 129, day 20707] was 543 — the 4-run dungeon day + the first 17-cast PUPPETEER (924) batch */ /* [session 130, day 20708] was 560 */
