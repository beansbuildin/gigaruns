...
describe("the in-sample arm — reproducible from the committed corpus", () => {
  it("computes the shadowed rule's firing rate on the corpus, both clauses", () => {
    ...
    expect(r.plays).toBe(1020) /* [s116b] was 888 */;  /* [session 121] was 932 */ /* [session 116] was 808 — the 364-cast corpus */ // [session 99] the 210-cast corpus /* [session 102] was 553 */ /* [session 105] was 592 */  /* [session 107] was 605 */  /* [session 110] was 643 */  /* [session 110b] was 687 */  /* [session 113] was 699 */  /* [session 118] was 893 */  /* [session 122] was 979 */
    expect(r.fires).toBe(25); /* [session 102] was 17 */ /* [session 105] was 18 */  /* [session 110] was 19 */  /* [session 110b] was 20 */  /* [session 122] was 23 */
    expect(r.rate).toBeCloseTo(0.024509803921568627, /* [s116b] was 0.0259009009009009 */ 12);  /* [session 121] was 0.02467811158798283 */ /* [session 116] was 0.028465346534653466 (23/808); fires UNCHANGED at 23 across a 25-cast day, so the rate fell purely on the denominator */ /* [session 102] was 0.030741410488245932 (17/553) */ /* [session 105] was 0.030405405405405407 */  /* [session 107] was 0.03140495867768595 */  /* [session 110] was 0.029548989113530325 */  /* [session 110b] was 0.02911208151382824 */  /* [session 113] was 0.030042918454935622 */  /* [session 118] was 0.025755879059350503 */  /* [session 122] was 0.02349336057201226 */
  });
