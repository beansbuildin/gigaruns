...
describe("the in-sample arm — reproducible from the committed corpus", () => {
  it("computes the shadowed rule's firing rate on the corpus, both clauses", () => {
    ...
    expect(r.plays).toBe(1248 /* [session 128] was 1242 — day 20705 */ /* [session 128] was 1196 — +46, day 20705 */ /* [session 124] was 1074 */) /* [s116b] was 888 */;  /* [session 121] was 932 */ /* [session 116] was 808 — the 364-cast corpus */ // [session 99] the 210-cast corpus /* [session 102] was 553 */ /* [session 105] was 592 */  /* [session 107] was 605 */  /* [session 110] was 643 */  /* [session 110b] was 687 */  /* [session 113] was 699 */  /* [session 118] was 893 */  /* [session 122] was 979 */  /* [session 123] was 1020 */  /* [session 126] was 1190 */
