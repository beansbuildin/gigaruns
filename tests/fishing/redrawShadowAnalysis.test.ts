...
describe("the in-sample arm — reproducible from the committed corpus", () => {
  it("computes the shadowed rule's firing rate on the corpus, both clauses", () => {
    ...
    expect(r.plays).toBe(687); // [session 99] the 210-cast corpus /* [session 102] was 553 */ /* [session 105] was 592 */  /* [session 107] was 605 */  /* [session 110] was 643 */
    expect(r.fires).toBe(20); /* [session 102] was 17 */ /* [session 105] was 18 */  /* [session 110] was 19 */
    expect(r.rate).toBeCloseTo(0.02911208151382824, 12); /* [session 102] was 0.030741410488245932 (17/553) */ /* [session 105] was 0.030405405405405407 */  /* [session 107] was 0.03140495867768595 */  /* [session 110] was 0.029548989113530325 */
  });
