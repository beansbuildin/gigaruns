...
describe("the era predicate itself", () => {
  it("dates every cast off committed fixtures", () => {
    ...
    expect(created.size).toBe(390) /* [s116b] was 364 */ /* [session 116] was 339 */;  /* [session 113] was 295 */  /* [session 92] was 178 */ // [session 93] was 188  // [session 96] was 189  // [session 98] was 199  /* [session 99] was 208 */ /* [session 102] was 210 */ /* [session 105] was 230 */  /* [session 107] was 251 */  /* [session 110] was 273 */  /* [session 110b] was 288 */  /* [session 118] was 367 */
...
describe("GATE 1a — the focus-budget era split", () => {
  ...
  it("reads 44.9% preOil / 1.7% oilSupplied / 33.0% focusDry / 29.7% pooled", () => {
    ...
    expect(s.oilSupplied.casts + s.focusDry.casts).toBe(296) /* [s116b] was 270 */ /* [session 116] was 245 */;  /* [session 113] was 201 */ // [session 96] was 95  // [session 98] was 105  /* [session 99] was 114 */ /* [session 102] was 116 */ /* [session 105] was 136 */  /* [session 107] was 157 */  /* [session 110] was 179 */  /* [session 110b] was 194 */  /* [session 118] was 273 */
    expect(s.oilSupplied.plays + s.focusDry.plays).toBe(1112) /* [s116b] was 1026 */ /* [session 116] was 910 */;  /* [session 113] was 737 */  // [session 96] was 367  // [session 98] was 410  /* [session 99] was 450 */ /* [session 102] was 459 */ /* [session 105] was 529 */  /* [session 107] was 579 */  /* [session 110] was 648 */  /* [session 110b] was 715 */  /* [session 118] was 1034 */
    expect(s.oilSupplied.budgetZero + s.focusDry.budgetZero).toBe(242) /* [s116b] was 225 */ /* [session 116] was 188 */;  /* [session 113] was 130 */  // [session 96] was 41  // [session 98] was 50 /* [session 102] was 63 */ /* [session 105] was 78 */  /* [session 107] was 85 */  /* [session 110] was 100 */  /* [session 110b] was 121 */  /* [session 118] was 226 */
  ...
  it("shows the frozen tail is a CAST-level incidence, not a per-play one", () => {
    ...
    expect(s.focusDry.castsEverFrozen).toBe(64) /* [s116b] was 59 */ /* [session 116] was 50 */;  /* [session 113] was 36 */  // [session 96] was 10  // [session 98] was 12 /* [session 102] was 16 */ /* [session 105] was 22 */  /* [session 107] was 25 */  /* [session 110] was 29 */  /* [session 110b] was 34 */  /* [session 118] was 60 */
  });
...
describe("GATE 1b — the redraw counterfactual, conditioned on the era", () => {
  ...
  it("all but RESTORES `neither = 0` — it is 1, and the 11 others were Focus-dry casts", () => {
    ...
    expect(redrawCounterfactual(split.focusDry).neitherReaches).toBe(68) /* [s116b] was 64 */ /* [session 116] was 54 */;  /* [session 113] was 37 */  // [session 96] was 14  // [session 98] was 16 /* [session 102] was 20 */ /* [session 105] was 26 */  /* [session 107] was 28 */  /* [session 110] was 30 */  /* [session 110b] was 36 */  /* [session 118] was 65 */
    expect(
      redrawCounterfactual(split.oilSupplied).neitherReaches +
        redrawCounterfactual(split.focusDry).neitherReaches,
    ).toBe(69) /* [s116b] was 65 */ /* [session 116] was 55 */;  /* [session 113] was 38 */  // [session 96] was 15  // [session 98] was 17 /* [session 102] was 21 */ /* [session 105] was 27 */  /* [session 107] was 29 */  /* [session 110] was 31 */  /* [session 110b] was 37 */  /* [session 118] was 66 */
  });
  ...
  it("puts session 83's unexplained residual almost ENTIRELY in the preOil arm again", () => {
    ...
    expect(pooled.neitherReaches).toBe(125) /* [s116b] was 121 */ /* [session 116] was 111 */;  /* [session 113] was 94 */  // [session 96] was 71  // [session 98] was 73 /* [session 102] was 77 */ /* [session 105] was 83 */  /* [session 107] was 85 */  /* [session 110] was 87 */  /* [session 110b] was 93 */  /* [session 118] was 122 */
...
describe("GATE 2 — the collapse, decomposed", () => {
  ...
  it("detects oils on consumablesUsed, NOT on the focus meter — they give different answers", () => {
    ...
    expect(traces.filter(firedOil).length).toBe(86) /* [session 116] was 80 */;  /* [session 113] was 72 */ // [session 93] was 39  // [session 96] was 40  // [session 98] was 41 — the batch's four double-lethal casts /* [session 102] was 45 */ /* [session 105] was 52 */  /* [session 107] was 61 */  /* [session 110] was 65 */  /* [session 110b] was 70 */  /* [session 118] was 82 */
  ...
  it("[§33 FIXED, session 93] the closing-turn oils are VISIBLE now — and there were 27 of them, not 6", () => {
    ...
    expect(blind.length).toBe(74) /* [session 116] was 68 */;  /* [session 113] was 60 */ // [session 93] was 27  // [session 96] was 28  // [session 98] was 29 /* [session 102] was 33 */ /* [session 105] was 40 */  /* [session 107] was 49 */  /* [session 110] was 53 */  /* [session 110b] was 58 */  /* [session 118] was 70 */
    ...
    expect(blind.filter((t) => eraOf(t.docId, created) !== "preOil").length).toBe(73) /* [session 116] was 67 */;  /* [session 113] was 59 */ // [session 93] was 26  // [session 96] was 27  // [session 98] was 28 /* [session 102] was 32 */ /* [session 105] was 39 */  /* [session 107] was 48 */  /* [session 110] was 52 */  /* [session 110b] was 57 */  /* [session 118] was 69 */
  });
...
describe("§3's heldCoverage signal, re-run per era", () => {
  it("SURVIVES the split — the dead hands changed, the separation did not", () => {
    ...
    expect(pooled.coverageAuc).toBeCloseTo(0.9210887716985278, /* [session 116] was 0.9199010229173572 */ 3);  /* [session 113] was 0.9198765301815112 */  // [session 98] was 0.924  /* [session 99] was 0.9214675201517307 */ /* [session 102] was 0.9226142809476143 */ /* [session 105] was 0.9255802035288089 */  /* [session 107] was 0.926938202247191 */  /* [session 110b] was 0.9234586466165413 */  /* [session 118] was 0.9222266634861487 */
...
describe("§1 / GATE 1 — the bot stopped OVERSHOOTING; the target never moved", () => {
  ...
  it("matches on the whole optimal DISTRIBUTION, not just its mean", () => {
    ...
    expect(over.focusDry.actualHistogram.get(3) ?? 0).toBe(8) /* [session 116] was 6 */;  /* [session 113] was 3 */  /* [session 110b] was 2 */  /* [session 118] was 7 */
  });
