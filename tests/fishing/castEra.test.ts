...
describe("GATE 2 — the collapse, decomposed", () => {
  ...
  it("detects oils on consumablesUsed, NOT on the focus meter — they give different answers", () => {
    ...
    expect(traces.filter(firedOil).length).toBe(82) /* [session 116] was 80 */;  /* [session 113] was 72 */ // [session 93] was 39  // [session 96] was 40  // [session 98] was 41 — the batch's four double-lethal casts /* [session 102] was 45 */ /* [session 105] was 52 */  /* [session 107] was 61 */  /* [session 110] was 65 */  /* [session 110b] was 70 */
  ...
  it("[§33 FIXED, session 93] the closing-turn oils are VISIBLE now — and there were 27 of them, not 6", () => {
    ...
    expect(blind.length).toBe(70) /* [session 116] was 68 */;  /* [session 113] was 60 */ // [session 93] was 27  // [session 96] was 28  // [session 98] was 29 /* [session 102] was 33 */ /* [session 105] was 40 */  /* [session 107] was 49 */  /* [session 110] was 53 */  /* [session 110b] was 58 */
    ...
    expect(blind.filter((t) => eraOf(t.docId, created) !== "preOil").length).toBe(69) /* [session 116] was 67 */;  /* [session 113] was 59 */ // [session 93] was 26  // [session 96] was 27  // [session 98] was 28 /* [session 102] was 32 */ /* [session 105] was 39 */  /* [session 107] was 48 */  /* [session 110] was 52 */  /* [session 110b] was 57 */
  });
...
describe("§3's heldCoverage signal, re-run per era", () => {
  it("SURVIVES the split — the dead hands changed, the separation did not", () => {
    ...
    expect(pooled.coverageAuc).toBeCloseTo(0.9222266634861487, /* [session 116] was 0.9199010229173572 */ 3);  /* [session 113] was 0.9198765301815112 */  // [session 98] was 0.924  /* [session 99] was 0.9214675201517307 */ /* [session 102] was 0.9226142809476143 */ /* [session 105] was 0.9255802035288089 */  /* [session 107] was 0.926938202247191 */  /* [session 110b] was 0.9234586466165413 */
...
describe("§1 / GATE 1 — the bot stopped OVERSHOOTING; the target never moved", () => {
  ...
  it("matches on the whole optimal DISTRIBUTION, not just its mean", () => {
    ...
    expect(over.focusDry.actualHistogram.get(3) ?? 0).toBe(7) /* [session 116] was 6 */;  /* [session 113] was 3 */  /* [session 110b] was 2 */
  });
