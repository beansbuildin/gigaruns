...
describe("loadFishingCorpus / summarizeFishingCorpus — against the real committed corpus", () => {
  it("counts by docId, not by directory or raw file — reproduces the CODEXREVIEW-corrected numbers", () => {
    ...
    // [session 116] 339 -> 364 across a TWENTY-FIVE-cast day in two batches
    // (11 then 14): +159 responseDocs, +116 playTurns, +16 caught, +9 escaped.
    // `incomplete` is UNCHANGED at 1 once again. The caught share of the
    // ADDITION is 16/25 = 64.0%, inside the user's stated 60-70% framing and
    // not separable from the era baseline. ⚠ **25 casts were PLAYED but only
    // 17 charged against the game's daily ledger: JEBAITOR (§34) fired EIGHT
    // times** — and the skill has been LEVELLED, its `value` now reading 15.75
    // against 6.75 on 2026-08-24 and 2.25 on 2026-08-21. Events matched
    // uncharged casts 8-for-8 in this day alone.
        // [session 118] The day-20698 batch: **8 casts PLAYED, 7 CHARGED** against
    // dayDocs[pondId 2] — JEBAITOR (§34) spared one. 5 of 8 caught (62.5%),
    // inside the user's 60-70% target framing. Every delta below is checked
    // against the batch log rather than accepted as whatever the corpus said:
    // +8 casts, +45 responseDocs (= the log's 45 post_response events),
    // +31 playTurns (= its 31 decision events), +5 caught (= its 5 cast_over
    // rows with outcome "caught"). All four reconcile exactly.
    // [session 121] +20 casts, the FULL day-20699 fishing cap in two 10-cast
    // batches. Deltas checked against the two batch logs rather than accepted
    // from the corpus: +11 caught (batch 1 four, batch 2 seven) and +9 escaped,
    ...
    expect(summary.casts).toBe(674 /* [session 133, day 20711] was 584 */ /* [session 131, day 20709] was 564 */ /* [session 128] was 534 — day 20705 */ /* [session 128] was 509 — +25, day 20705 */ /* [session 124] was 457 */)  /* [session 121] was 390 */ /* [session 118] was 367 */ /* [s116b] was 364 */;  /* [session 116] was 339 */  /* [session 113] was 295 */ // [session 98] was 199; was 189  /* [session 99] was 208 */ /* [session 101] was 210 */ /* [session 102] was 230 */  /* [session 107] was 251 */  /* [session 110] was 273 */  /* [session 110b] was 288 */  /* [session 122] was 410 */  /* [session 123] was 433 */  /* [session 126] was 507 */ /* [session 129, day 20707] was 537 — the 4-run dungeon day + the first 17-cast PUPPETEER (924) batch */ /* [session 130, day 20708] was 554 */
    expect(summary.responseDocs).toBe(3852 /* [session 133, day 20711] was 3301 */ /* [session 131, day 20709] was 3179 */ /* [session 128] was 3015 — day 20705 */ /* [session 128] was 2884 — day 20705 */ /* [session 124] was 2596 */)  /* [session 121] was 2233 */ /* [session 118] was 2113 */ /* [s116b] was 2101 */;  /* [session 116] was 1942 */  /* [session 113] was 1691 */ // [session 98] was 1149; was 1091  /* [session 99] was 1212 */ /* [session 101] was 1224 */ /* [session 102] was 1341 */  /* [session 107] was 1441 */  /* [session 110] was 1552 */  /* [session 110b] was 1653 */  /* [session 122] was 2345 */  /* [session 123] was 2465 */  /* [session 126] was 2871 */ /* [session 129, day 20707] was 3031 — the 4-run dungeon day + the first 17-cast PUPPETEER (924) batch */ /* [session 130, day 20708] was 3111 */
    expect(summary.playTurns).toBe(2665 /* [session 133, day 20711] was 2267 */ /* [session 131, day 20709] was 2176 */ /* [session 128] was 2057 — day 20705 */ /* [session 128] was 1971 — day 20705 */ /* [session 124] was 1774 */)  /* [session 121] was 1523 */ /* [session 118] was 1445 */ /* [s116b] was 1437 */;  /* [session 116] was 1321 */  /* [session 113] was 1148 */ // [session 98] was 821; [session 96] was 778  /* [session 99] was 861 */ /* [session 101] was 870 */ /* [session 102] was 940 */  /* [session 107] was 990 */  /* [session 110] was 1059 */  /* [session 110b] was 1126 */  /* [session 122] was 1601 */  /* [session 123] was 1681 */  /* [session 126] was 1962 */ /* [session 129, day 20707] was 2069 — the 4-run dungeon day + the first 17-cast PUPPETEER (924) batch */ /* [session 130, day 20708] was 2123 */
    expect(summary.caught).toBe(341 /* [session 133, day 20711] was 291 */ /* [session 131, day 20709] was 282 */ /* [session 128] was 270 — day 20705 */ /* [session 128] was 255 — day 20705 */ /* [session 124] was 228 */)  /* [session 121] was 192 */ /* [session 118] was 177 */ /* [s116b] was 176 */;  /* [session 116] was 160 */  /* [session 113] was 134 */ // [session 98] was 73; [session 96] was 70  /* [session 99] was 79 */ /* [session 101] was 80 */ /* [session 102] was 94 */  /* [session 107] was 108 */  /* [session 110] was 120 */  /* [session 110b] was 129 */  /* [session 122] was 203 */  /* [session 123] was 217 */  /* [session 126] was 254 */ /* [session 129, day 20707] was 271 — the 4-run dungeon day + the first 17-cast PUPPETEER (924) batch */ /* [session 130, day 20708] was 278 */
    expect(summary.escaped).toBe(332 /* [session 133, day 20711] was 292 */ /* [session 131, day 20709] was 281 */ /* [session 128] was 263 — day 20705 */ /* [session 128] was 253 — day 20705 */ /* [session 124] was 228 */)  /* [session 121] was 197 */ /* [session 118] was 189 — +3, the batch's 3 escapes; 182+192+1 = 375 so the partition still closes */ /* [s116b] was 187 */;  /* [session 116] was 178 */  /* [session 113] was 160 */ // [session 98] was 125; [session 96] was 118  /* [session 99] was 128 */ /* [session 101] was 129 */ /* [session 102] was 135 */  /* [session 107] was 142 */  /* [session 110] was 152 */  /* [session 110b] was 158 */  /* [session 122] was 206 */  /* [session 123] was 215 */  /* [session 126] was 252 */ /* [session 129, day 20707] was 265 — the 4-run dungeon day + the first 17-cast PUPPETEER (924) batch */ /* [session 130, day 20708] was 275 */
...
describe("the oil flag — derived off the server's own consumablesUsed", () => {
  ...
  it("finds the two consumable casts — one inherited, one this bot's own first oil spend", () => {
    ...
    expect(oilCasts.map((c) => c.docId)).toEqual([
      // [session 123] +3 from the day-20701 24-cast batch — the FIRST
      // batch on the DENDREN rod. Verified ADDITIVE: nothing was removed, so no
      // earlier oil cast fell out of the corpus. Relaxing-only, as the standing
      // [USER] policy requires; the per-cast cap of 2 still has never bound.
      ...
      "13320153", // [session 125] day-20703
      "13320155", // [session 125] day-20703
      "13320158", // [session 125] day-20703
      "13320196", // [session 125] day-20703
      "13320217", // [session 125] day-20703
      "13320227", // [session 125] day-20703
      "13338561",
      // ⭐ [session 128] +5 from day 20705's 25-cast Dendren batch (5 Relaxing
      // oils, Focus 0 — Focus is off the allowlist and its triggers log
      // policy-withdrawn). Verified ADDITIVE by a multiset diff both ways:
      // five additions, ZERO removals, and the 105 above are byte-identical.
      "13355552", "13355557", "13355562", "13355586", "13355594", // [session 126] +1 from the day-20704 oil batch — the day-20704 batch's FIRST cast — a Relaxing-oil cast that CAUGHT after 1 turn. Verified ADDITIVE: nothing was removed.
      // ⭐ [session 129, day 20707] +2 from the 17-cast PUPPETEER (924) batch —
      // the FIRST batch on that rod. Relaxing-only per the standing [USER]
      // policy; the per-cast cap of 2 still has never bound. Verified
      // ADDITIVE: nothing was removed, so no earlier oil cast fell out.
      "13385848", "13385850",
      "13403226", // [session 130, day 20708] +1 from the second Puppeteer batch — the one Relaxing oil consumed; ADDITIVE, 0 removals
      "13419650", // [session 131, day 20709] +1 from the first batch back on GOLKAN (812) — the one Relaxing oil consumed (cast 3); ADDITIVE, 0 removals
      "13419927", // [session 131, day 20709] +1 from the second Golkan batch (post-repair) — its one Relaxing oil; ADDITIVE, 0 removals
      "13434197", // [session 133, day 20711]
      "13434204", // [session 133, day 20711]
      "13434225", // [session 133, day 20711]
      "13434233", // [session 133, day 20711]
      "13434239", // [session 133, day 20711]
      "13434264", // [session 133, day 20711]
      "13450646", // [session 133, day 20711]
      "13450660", // [session 133, day 20711]
      "13450751", // [session 133, day 20711]
      // [session 134, day 20713] +3 from the 24-cast Golkan batch — the three
      // Relaxing oils this session spent. Verified ADDITIVE by diff: 3 added,
      // 0 removed. Relaxing-only, as the standing [USER] policy requires; the
      // per-cast cap of 2 still has never bound.
      "13465852", "13465949", "13466118",
